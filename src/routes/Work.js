  ...
  return (
    <main className='work'>
      <div className='work-con'>
        <ul className='work-list'>
            ...
            <div class='work-list__text'>
              <div className='work-list__header'>
                <div className='work-list__header-title'>
                  <strong className='work-list__header-title-back'>Mobiconnect Admin </strong>
                  <strong className='work-list__header-title-front'>Mobiconnect Admin</strong>
                </div>
                <a
                  className='work-list__view-website'
                  href='#'
              ...
              <p className='work-list__desc'>
                Global AD Network Platform Administrator
                <br />
                <ol>
                  <li>dd</li>
                </ol>
          ...
          <li className='work-list__item'>
            ...
            <div class='work-list__text'>
              <div className='work-list__header'>
                ...
                <a
                  className='work-list__view-website'
                  href='https://www.mobiconnect.co.kr/api/'
                  target='_blank'
                  rel='noopener noreferrer'
                  title='View this Website'
                >
              ...
              <p className='work-list__desc'>
                Responsive Website providing API key for an international marketplace platform where
                global mobile traffic all around the world comes together.
                <br />
              </p>
              <div className='work-list__ability'>
                <span># HTML</span>
          ...
          <li className='work-list__item'>
            ...
            <div class='work-list__text'>
              <div className='work-list__header'>
                <div className='work-list__header-title'>
                  <strong className='work-list__header-title-back'>
                    Recruitment Administrator : Mobidays
                  </strong>
                  <strong className='work-list__header-title-front'>
                    Recruitment Administrator : Mobidays
                  </strong>
                </div>
                <a
              ...
              <p className='work-list__desc'>Simple Recruitment Admin Site</p>
              <div className='work-list__ability'>
                <span># HTML</span>
                <span># CSS</span>
                <span># jQuery</span>
        ...
        <aside className='work-list__title' style={{ left: '-25%', top: '10%' }}>
          RECENT WORK
        </aside>
      </div>
      <div className='work-con'>
        ...
        <aside className='work-list__title' style={{ left: '-29%', top: '12%' }}>
          PERSONAL WORK
        </aside>
      </div>
    </main>
